...
public class DateTimeExample {
    ...
    public static void getLocalDateTimeDescription(){
        ...
        String strWithDate = "2017-05-14T23:10:10";
        ...
        strWithDate =  "22 декабря 2009 в 15 00 10";
        DateTimeFormatter dtf = DateTimeFormatter.ofPattern("dd MMMM yyyy в HH mm ss"); // определяем формат даты,
